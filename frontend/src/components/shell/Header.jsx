...
export default function Header() {
  ...
  return (
    <header 
      className={`bg-surface/95 backdrop-blur-md shadow-sm fixed top-0 left-0 md:left-64 right-0 lg:right-80 z-20 border-b border-gray-200 transition-transform duration-300 ${
